...
library Compounding {
    ...
    /// @dev NOTE: In real use, change to *internal*. Was left as external in order to get a gas report...
    function continuouslyCompounded(uint256 principal, uint256 elapsed, uint256 interestRate) external pure returns (uint256) {
